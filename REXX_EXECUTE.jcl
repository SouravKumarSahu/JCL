...
#EXECUTE MSGID REXX VIA MVS USING JCL#
//REXXJCL  EXEC PGM=IKJEFT01                  
//SYSEXEC  DD DSN=&SYSUID..CH15.CLIST,DISP=SHR
//SYSPRINT DD SYSOUT=*                        
//SYSTSPRT DD SYSOUT=*                        
//SYSTSIN  DD *                               
EX CH15(MSGID)                                
...
#EXECUTE MSGID REXX WITHOUT JCL#
ex ch15(MSGID)
